...
abstract class Driver {
	...
	static enum Support {
		CONNECT, TRANSACTIONAL, START_TRANSACTION, SQL, MULTIDATABASE, LOCAL_TEMPORARY, GLOBAL_TEMPORARY, MEMORY, EXTERNAL, SEQUENCE, BATCH,
		...
		NOT_NULL_FIELD, DEFAULT_VALUE, CHECK_FIELD, COMPUTE_FIELD, COLUMN_CHANGE_TYPE,
		ALTER_COLUMN, ALTER_DEFAULT_VALUE, DROP_DEFAULT_VALUE, PRIMARY_KEY, DROP_CONSTRAINT,
		VIEW, LOCAL_TEMPORARY_VIEW, SCHEMA, DROPVIEWIFEXISTS, CREATEVIEWIFNOTEXISTS,
		DATABASE, SELECT_WITHOUT_FROM,
		TIMESTAMP, DATE, TIME, TIMESTAMP_WITH_TIMEZONE, BOOLEAN, BLOB, CLOB, UUID, ARRAY, AUTO_INCREMENT
	}
	...
	/** Initialization driver parameters */
