...
class FileDataset extends Dataset {
	 ...
	 */
	public boolean getAppend () { ListUtils.NotNullValue([params.append, connection.append, false]) }
	public void setAppend (boolean value) { params.append = value }
	
	/**
	 * Auto create path for connection
	 */
	public boolean getCreatePath () { ListUtils.NotNullValue([params.createPath, connection.createPath, false]) }
	public void setCreatePath (boolean value) { params.createPath = value }
	
	/**
	 * Delete file if empty after write
	 */
	public boolean getDeleteOnEmpty () { ListUtils.NotNullValue([params.deleteOnEmpty ,connection.deleteOnEmpty, false]) }
	public void setDeleteOnEmpty (boolean value) { params.deleteOnEmpty = value }
	
	/**
	 * File is pack of GZIP
	 */
	public boolean getIsGzFile() { ListUtils.NotNullValue([params.isGzFile, connection.isGzFile, false]) }
	...
	public void openWrite (Map procParams) {
		sysParams.deleteOnEmpty = ListUtils.NotNullValue([procParams.deleteOnEmpty, deleteOnEmpty])
	...
	public void closeWrite () {
		super.closeWrite()
		if (!ListUtils.NotNullValue([sysParams.append, append, false])) {
	...
	public void setConnection(Connection value) {
		assert value instanceof FileConnection
