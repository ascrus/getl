...
class OracleDriver extends JDBCDriver {
	...
	protected void initParams() {
		...
		sqlExpressions.ddlAutoIncrement = 'GENERATED BY DEFAULT ON NULL AS IDENTITY'
...
begin
	...
	List<Driver.Support> supported() {
		...
		if (jdbcConnection.serverMajorVersion >= 12)
			res.add(Support.AUTO_INCREMENT)

		if (jdbcConnection.serverMajorVersion >= 23)
