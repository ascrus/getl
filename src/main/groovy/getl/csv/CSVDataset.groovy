...
class CSVDataset extends FileDataset {
	 ...
	 */
	public boolean getHeader () { ListUtils.NotNullValue([params.header, connection?.header, true]) }
	public void setHeader (boolean value) { params.header = value }
	
	/**
	 * Ignore header field name
	 */
	public boolean getIgnoreHeader () { ListUtils.NotNullValue([params.ignoreHeader, connection?.ignoreHeader, false]) }
	public void setIgnoreHeader (boolean value) { params.ignoreHeader = value }
	
	/**
	 * Required format values for output to file 
	 */
	public boolean getFormatOutput () { ListUtils.NotNullValue([params.formatOutput, connection?.formatOutput, true]) }
	 ...
	 */
	public boolean getEscaped () { ListUtils.NotNullValue([params.escaped, connection?.escaped, false]) }
	...
	public void setConnection(Connection value) {
		assert value instanceof CSVConnection
