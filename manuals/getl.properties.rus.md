...
установлена среда dev. Разработчик может создать себе собственный файл конфигурации в корне модуля с генераторами и 
указать, что вместо dev нужно использовать другую среду выполнения. В этом случае рекомендуется добавить файл 
getl-repository-env.conf в игнорируемые файлы системы контроля версий, чтобы исключить их отслеживание и репликацию 
среди разработчиков.
